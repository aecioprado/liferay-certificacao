...
package boletim.service.persistence;
...
public class TarefaUtil {
	...
	public static Tarefa findByUuid_First(
		...
		throws boletim.exception.NoSuchTarefaException {
