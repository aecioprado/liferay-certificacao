...
package com.liferay.treinamento.boletim.service.persistence.impl;
...
import com.liferay.treinamento.boletim.model.TarefaTable;
import com.liferay.treinamento.boletim.model.impl.TarefaImpl;
import com.liferay.treinamento.boletim.model.impl.TarefaModelImpl;
import com.liferay.treinamento.boletim.service.persistence.TarefaPersistence;
import com.liferay.treinamento.boletim.service.persistence.TarefaUtil;
import com.liferay.treinamento.boletim.service.persistence.impl.constants.BoletimPersistenceConstants;
...
public class TarefaPersistenceImpl
	...
	@Override
	@Reference(
		target = BoletimPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = BoletimPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
